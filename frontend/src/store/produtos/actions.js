...
const produtos = [
    {
        ...
        imagem: './Imagens/Notebook_Gamer_Acer_Nitro_5.jpg',
        nota: 4.5,
        tag: 'notebook',
        precoBase: 6499.99,
        precoPromocional: 5999.99,
        precoParcelado: (6499.99/12),
        especificacoes: {
    ...
    },
    {
        ...
        imagem: './Imagens/Notebook_Gamer_Lenovo_Legion_Y540.jpeg',
        nota: 4.5,
        tag: 'notebook',
        precoBase: 6999.99,
        precoPromocional: 6499.99,
        precoParcelado: (6999.99/12),
        especificacoes: {
            destaque: 'NVIDIA GeForce GTX 1660 Ti',
            Processador: 'Intel Core i7-9750H',
            Memória: '16GB DDR4',
    ...
    },
    {
        ...
        imagem: './Imagens/Processador_AMD_Ryzen_7_5700X3D.jpeg',
        imagem: './Imagens/Processador_AMD_Ryzen_7_5700X3D.jpeg',
        nota: 4.5,
        tag: 'processador',
        precoBase: 2499.99,
        precoPromocional: 1189.99,
        precoParcelado: (2499.99/12),
        especificacoes: {
    ...
    },
    {
        ...
        imagem: './Imagens/Processador_Intel_Core_i9-13900K.jpeg',
        nota: 4.8,
        tag: 'processador',
        precoBase: 3899.99,
        precoPromocional: 3299.99,
        precoParcelado: (3899.99/12),
        especificacoes: {
    ...
    },
    {
        ...
        imagem: './Imagens/Teclado_Mecanico_Gamer_Razer_BlackWidow_V3.jpeg',
        nota: 4.7,
        tag: 'teclado',
        precoBase: 1299.99,
        precoPromocional: 999.99,
        precoParcelado: (1299.99/12),
        especificacoes: {
    ...
    },
    {
        ...
        marca: 'Logitech',
        modelo: '910-005631',
        imagem: './Imagens/Mouse_Gamer_Logitech_G403_Hero.jpeg',
        nota: 4.8,
        tag: 'mouse',
        precoBase: 399.99,
        precoPromocional: 299.99,
        precoParcelado: (399.99/12),
        especificacoes: {
    ...
    },
    {
        ...
        imagem: './Imagens/Mouse_Gamer_Razer_DeathAdder_V2.jpeg',
        nota: 4.7,
        tag: 'mouse',
        precoBase: 499.99,
        precoPromocional: 399.99,
        precoParcelado: (499.99/12),
        especificacoes: {
    ...
    },
    {
        ...
        imagem: './Imagens/Monitor_Gamer_Samsung_Odyssey_G7_27.jpeg',
        nota: 4.9,
        tag: 'monitor',
        precoBase: 3499.99,
        precoPromocional: 2999.99,
        precoParcelado: (3499.99/12),
        especificacoes: {
    ...
    },
    {
        ...
        marca: 'LG',
        modelo: '34GN850-B',
        imagem: './Imagens/Monitor_Gamer_LG_UltraGear_34.jpeg',
        nota: 4.7,
        tag: 'monitor',
        precoBase: 2999.99,
        precoPromocional: 2399.99,
        precoParcelado: (2999.99/12),
        especificacoes: {
    ...
    },
    {
        ...
        imagem: './Imagens/Placa_de_Video_NVIDIA_GeForce_RTX_3060_Ventus_2X_MSI.jpeg',
        nota: 4.9,
        tag: 'placa_de_video',
        precoBase: 2399.99,
        precoPromocional: 1999.99,
        precoParcelado: (2399.99/12),
        especificacoes: {
            destaque: '12GB GDDR6',
            'CUDA Cores': 3584,
    ...
    },
    {
        ...
        imagem: './Imagens/Placa_de_Video_AMD_Radeon_RX_6800_XT.jpeg',
        nota: 4.7,
        tag: 'placa_de_video',
        precoBase: 6449.99,
        precoPromocional: 5799.99,
        precoParcelado: (6449.99/12),
        especificacoes: {
            destaque: '16GB GDDR6',
    ...
    },
    {
        ...
        imagem: './Imagens/Placa_Mae_ASUS_ROG_Strix_Z590-E.jpeg',
        nota: 4.8,
        tag: 'placa_mae',
        precoBase: 2999.99,
    ...
    },
    {
        ...
        imagem: './Imagens/Placa_Mae_MSI_MAG_B550_Tomahawk.jpeg',
        nota: 4.7,
        tag: 'placa_mae',
        precoBase: 1399.99,
        precoPromocional: 999.99,
        precoParcelado: (1399.99/12),
        especificacoes: {
    ...
    },
    {
        ...
        imagem: './Imagens/Memoria_RAM_Corsair_Vengeance_RGB_Pro_16GB.jpeg',
        nota: 4.8,
        tag: 'memoria_ram',
        precoBase: 649.99,
        precoPromocional: 299.99,
        precoParcelado: (649.99/12),
        especificacoes: {
            destaque: '16GB (2x8GB)',
            Frequência: '3200MHz',
    ...
    },
    {
        ...
        imagem: './Imagens/Memoria_RAM_Kingston_Fury_Beast_32GB.jpeg',
        nota: 4.7,
        tag: 'memoria_ram',
        precoBase: 999.99,
        precoPromocional: 699.99,
        precoParcelado: (999.99/12),
        especificacoes: {
...
export const saveListProdutos=(list_produtos) => ({
    type:actionTypes.GET_PRODUTOS, 
    list_produtos:produtos
});

export const changeSelectProduto=(produto) => ({
    type:actionTypes.SELECT_PRODUTO, 
    select_produto:produto
});

export const changeFilterProdutos=(list_produtos) => ({
    type:actionTypes.CHANGE_FILTER_PRODUTOS, 
    filter_produtos:list_produtos
});

export const getProdutosBackend=(api_instance) => (dispatch) => {
    api_instance.get('/get_produtos')
    .then( (res) => {
        dispatch(saveListProdutos(res.data)) 
    } )
    .catch( (req) => {
        console.log("Valor em getProdutosBackend", req)
